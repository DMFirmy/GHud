...
internal class NativeMethods
{
	...
	///     Connection that is issuing the callback.  Compare with connection from LcdConnect/LcdConnectEx
	...
	/// <remarks>
	///     Must be paired with LcdDeInit.  Put LcdInit in your Form_Load
	///     or main and LcdDeInit in your exit function (ie. Form_Closing).
	/// </remarks>
	...
	/// <param name="isAutostartable">
	///     Sets your program to be startable by the Logitech LCD Manager when Windows starts up.
	///     Use 0 for most types of applications.
	/// </param>
	...
	/// <returns>Connection on success.  LGLCD_INVALID_CONNECTION on failure.</returns>
	/// <remarks>
	///     Use only after LcdInit.  Multiple connections are allowed.
	///     Use LcdConnectEx if you need to read the extended G-19 buttons.  Otherwise only BUTTON_1 through BUTTON_4 will be
	///     returned.
	/// </remarks>
	...
	/// <returns>ERROR_SUCCESS on success, standard Windows error otherwise.</returns>
	/// <remarks>
	///     You can send LGLCD_DEVICE_BW image to both monochrome and color devices.  If you send a
	...
	///     An image too large for the display will be truncated.  One too small will appear in the upper left.
	/// </remarks>
	/// <example>
